...
import org.firstinspires.ftc.teamcode.hardware.robots.methods.instantiations.BotMarkIIInstantiation;
import org.firstinspires.ftc.teamcode.hardware.robots.methods.misc.ZeroAll;
import org.firstinspires.ftc.teamcode.hardware.robots.methods.modulemovements.arm.CloseArmLid;
...
import org.firstinspires.ftc.teamcode.hardware.robots.methods.modulemovements.arm.OpenArmLid;
...
public final class BotMarkII extends GenericRobot implements MecanumDriveOpModeUsageMarkI {
    ...
    public BotMarkII(HardwareMap map) {
        ...
        addCommand(movements, new BotMarkIIInstantiation());
    }
    ...
    public void openArmLid() {
        arm.openLid();
        addCommand(movements, new OpenArmLid());
    }

    @Override
    public void closeArmLid() {
        arm.closeLid();
        addCommand(movements, new CloseArmLid());
    }
