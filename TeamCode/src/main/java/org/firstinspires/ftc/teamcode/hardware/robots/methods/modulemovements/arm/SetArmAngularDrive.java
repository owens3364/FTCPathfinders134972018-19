...
public final class SetArmAngularDrive implements RobotMethod {

    private final String[] ARGS;
    private static final String NAME = "bot.setArmAngularDrive";
    ...
    public SetArmAngularDrive(String[] args) {
        this.ARGS = args;
    }
}
